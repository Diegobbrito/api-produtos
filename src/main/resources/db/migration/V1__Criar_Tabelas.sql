 ...
 create table venda_produto (venda_id bigint not null, produto bigint not null) engine=InnoDB;
 ...
 alter table venda_produto add constraint FKavpua646n39oesfu2nypqtijj foreign key (produto) references produto (id);
